...
.card-qr:hover .card-button-start {
...
#html5-qrcode-button-camera-start {
    ...
    /* Padding tombol */
    cursor: pointer;
    /* Kursor tipe pointer saat diarahkan */
}

/* Gaya tombol "Stop Scanning" */
...
/* Gaya tautan "Scan an Image File" */
#html5-qrcode-anchor-scan-type-change {
    ...
    /* Kursor tipe pointer saat diarahkan */
    display: inline-block;
    /* Menampilkan tautan dalam satu baris */
    margin-top: 10px;
    /* Jarak atas dari tautan */
}
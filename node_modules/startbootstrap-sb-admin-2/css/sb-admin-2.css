...
.section-content.step1.active.d-block #reader {
  position: relative;
  padding: 0px;
  border: 1px solid silver;
}

.section-content.step1.active.d-block #reader>div {
  text-align: left;
  margin: 0px;
}

.section-content.step1.active.d-block #reader>div>div {
  position: absolute;
  top: 10px;
  right: 10px;
  z-index: 2;
...
.section-content.step1.active.d-block #reader>div>img {
  position: absolute;
  top: 4px;
  right: 4px;
  opacity: 0.6;
...
.section-content.step1.active.d-block #reader__header_message {
  display: none;
  text-align: center;
  font-size: 14px;
  padding: 2px 10px;
...
.section-content.step1.active.d-block #reader__scan_region {
  width: 100%;
  min-height: 100px;
  text-align: center;
  position: relative;
...
.section-content.step1.active.d-block #reader__dashboard {
  width: 100%;
}

.section-content.step1.active.d-block #reader__dashboard_section {
  width: 100%;
  padding: 10px 0px;
  text-align: left;
}

.section-content.step1.active.d-block #reader__dashboard_section_csr {
  display: block;
  text-align: center;
}

.section-content.step1.active.d-block #reader__dashboard_section_csr>div {
  display: none;
  padding: 5px 10px;
  text-align: center;
}

.section-content.step1.active.d-block #reader__dashboard_section_csr>div>input[type="range"] {
  display: inline-block;
  width: 50%;
  height: 5px;
...
.section-content.step1.active.d-block #reader__dashboard_section_csr>div>span {
  margin-right: 10px;
}

.section-content.step1.active.d-block #reader__dashboard_section_csr>div>select {
  margin-right: 10px;
  display: none;
}

.section-content.step1.active.d-block #reader__dashboard_section_csr>div>button {
  opacity: 1;
  display: inline-block;
}

.section-content.step1.active.d-block #reader__dashboard_section_csr>div>button[type="button"] {
  display: none;
  disabled: true;
}

.section-content.step1.active.d-block #reader__dashboard_section_csr>div>label {
  display: inline-block;
}

.section-content.step1.active.d-block #reader__dashboard_section_csr>div>label>input[type="file"] {
  display: none;
}

.section-content.step1.active.d-block #reader__dashboard_section_csr>div>div {
  font-weight: 400;
}

.section-content.step1.active.d-block #reader__dashboard_section_csr>div>a {
  text-decoration: underline;
  display: inline-block;
}